// index.js - Bot FiveM Player Tracker (Dengan Playtime Tracking - FIXED)
...
try {
    ...
    db = new sqlite3.Database('./data/playtime.db');
    ...
    console.error('❌ Gagal load SQLite:', error.message);
    console.log('⚠️ Playtime tracking akan dinonaktifkan');
